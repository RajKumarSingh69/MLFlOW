...
#2nd method for logging the artifacts
import mlflow
from mlflow_utils import get_mlflow_experiment
...
if __name__=="__main__":
    ...
    with mlflow.start_run(run_name="logging_artifacts", experiment_id=experiment.experiment_id) as run:
        ...
        path=r"F:\DATA_SCIENCE\MLOPS\MLFLOW\Practise3\run_artifacts"
        #here we are logging a artifact folder where all the things are present
        mlflow.log_artifacts(local_dir=path,artifact_path="run_artifacts")
